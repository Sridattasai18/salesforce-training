...
export default class EligibleJobs extends LightningElement {
    ...
    async handleApply(event) {
        ...
        try {
            ...
            // Dispatch custom event to notify parent portal
            const applicationCreatedEvent = new CustomEvent('applicationcreated', {
                detail: { jobId: jobId }
            });
            this.dispatchEvent(applicationCreatedEvent);
        } catch (err) {
            this.dispatchEvent(
                new ShowToastEvent({
